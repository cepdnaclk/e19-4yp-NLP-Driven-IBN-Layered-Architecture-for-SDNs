...
net = Containernet(controller=lambda name: RemoteController(name,ip='172.18.0.2'),switch=OVSSwitch)
...
d2 = net.addDocker('d2', ip='192.168.1.1/24', dimage="ubuntu22")
d3 = net.addDocker('d3', ip='192.168.1.2/24', dimage="ubuntu22")
d4 = net.addDocker('d4', ip='192.168.0.2/24', dimage="ubuntu22")
d5 = net.addDocker('d5', ip='10.0.0.1/8', dimage="ubuntu22")
