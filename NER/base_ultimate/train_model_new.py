...
data_files = {
    "train": "ner_data_train.jsonl",
    "validation": "ner_data_dev.jsonl",
    "test": "ner_data_test.jsonl"
}
...
training_args = TrainingArguments(
    output_dir="./bert-ner-network-cased-low",
...
trainer.save_model("./bert-ner-network-final-cased-low")
tokenizer.save_pretrained("./bert-ner-network-final-cased-low")
